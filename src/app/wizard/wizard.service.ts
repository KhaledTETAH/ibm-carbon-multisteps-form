...
export class WizardService {
  ...
  getGroupItemList(): Observable<ListItem[]>{
    let items : ListItem[] = [{content: "ROOT", selected: true
    }, {content: "ADMIN", selected: false}, {content: "USER", selected: false}];
    return of(items);
  }

  getTechnItemList(): Observable<ListItem[]>{
    let items : ListItem[] = [{content: "Unassigned", selected: true
    }, {content: "ADMIN", selected: false}, {content: "USER", selected: false}];
    return of(items);
  }
}
